...
//        let dataResult = try patchedJSONContent.reduced()
//        XCTAssertEqual(String(decoding: dataResult, as: UTF8.self), "{}")
//    }
//
//    func test_DSL_patchedJSONContent1() throws {
//        let patchedJSONContent: PatchedJSON = Content(JSONPatchType.emptyContent) {
//            Add(address: "", simpleContent: "\"alex\"".utf8Data)
//        }
//        let dataResult = try patchedJSONContent.reduced()
//        XCTAssertEqual(String(decoding: dataResult, as: UTF8.self), """
//                                                                    "alex"
...
//        let patchedJSONContent: PatchedJSON = Content(JSONPatchType.emptyContent) {
//            Add(address: "/new", simpleContent: "\"alex\"".utf8Data)
//            Add(address: "/new", simpleContent: "\"mike\"".utf8Data)
//        }
//        let dataResult = try patchedJSONContent.reduced()
//        XCTAssertEqual(String(decoding: dataResult, as: UTF8.self), """
//                                                                    {"new":"mike"}
...
//        let patchedJSONContent: PatchedJSON = Content(JSONPatchType.emptyContent) {
//            Add(address: "/myArray", simpleContent: "[]".utf8Data)
//            Add(address: "/myArray/-", simpleContent: "\"mike\"".utf8Data)
//            Add(address: "/myArray/-", simpleContent: "\"alex\"".utf8Data)
//        }
//        let dataResult = try patchedJSONContent.reduced()
//        XCTAssertEqual(String(decoding: dataResult, as: UTF8.self), """
//                                                                    {"myArray":["mike","alex"]}
